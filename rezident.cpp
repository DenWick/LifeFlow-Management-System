...
rezident::rezident(const std::string& n, const std::string& pre, const std::string& f, const std::string& s, int sal, const std::string& sp, const std::string& p, int an) 
: personalSpital(n, pre, f), 
medic(n, pre, f, s, sal), 
asistent(n, pre, f, sp, p), 
anRezidentiat(an) {}
